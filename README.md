...
Выполнены все основные пункты ДЗ. Практически всё содержимое данного задание не работает по причине сильного устаревания и различия синтаксиса с актуальными версиями модулей. Выполнить данное ДЗ в полной мере не представляется возможным.
