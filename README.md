...
Вопреки тексту ДЗ, в рамках данного курса в предыдущих ДЗ TravisCI не изучался. Соответственно для выполнение задания необходимые знания получены не были.
